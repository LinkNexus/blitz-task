...
Phase 2  Deployable MVP           ███████░░░   8/13  <- current focus
...
**Next three, in order:** L15 (real dashboard, now that L13 gives it a project list) → L15.5
(not-found redirect, which needs somewhere worth landing) → L20 (member management UI, whose
endpoints have existed since Phase 1). L14, L22's remaining coverage and L23's README are the
cleanup tail.
