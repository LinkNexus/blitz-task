...
namespace BlitzTask.Backend.Migrations
{
    ...
    [Migration("20260925071103_AddPushNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.Activity.ActivityEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.Notifications.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.ProjectSections.ProjectSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.ProjectTasks.ProjectTask", b =>
                {
                    ...
                    b.Property<DateTime?>("RecurrenceSpawnedAt")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.ProjectTasks.ProjectTaskDependency", b =>
                {
                    ...
                    b.HasKey("DependentTaskId", "DependsOnTaskId");
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.ProjectTasks.TaskReminder", b =>
                {
                    ...
                    b.Property<int>("MinutesBeforeDue")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.Projects.Project", b =>
                {
                    ...
                    b.HasIndex(new[] { "CreatedById" }, "IX_Projects_InboxPerUser")
                        .IsUnique()
                        .HasFilter("\"IsInbox\" = 1");
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.Projects.SavedView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.Push.PushSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.Activity.ActivityEvent", b =>
                {
                    b.HasOne("BlitzTask.Backend.Features.Auth.User", "Actor")
                        .WithMany()
                    ...
                    b.HasOne("BlitzTask.Backend.Features.ProjectTasks.ProjectTask", "Task")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.Notifications.Notification", b =>
                {
                    ...
                    b.HasOne("BlitzTask.Backend.Features.TaskComments.TaskComment", "Comment")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.ProjectTasks.ProjectTask", b =>
                {
                    ...
                    b.HasOne("BlitzTask.Backend.Features.ProjectSections.ProjectSection", "Section")
                        .WithMany()
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.ProjectTasks.ProjectTaskDependency", b =>
                {
                    b.HasOne("BlitzTask.Backend.Features.ProjectTasks.ProjectTask", "DependentTask")
                        .WithMany("BlockedBy")
                        .HasForeignKey("DependentTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlitzTask.Backend.Features.ProjectTasks.ProjectTask", "DependsOnTask")
                        .WithMany("Blocks")
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.ProjectTasks.TaskChecklistItem", b =>
                {
                    b.HasOne("BlitzTask.Backend.Features.ProjectTasks.ProjectTask", "ProjectTask")
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.ProjectTasks.TaskRecurrence", b =>
                {
                    b.HasOne("BlitzTask.Backend.Features.ProjectTasks.ProjectTask", "ProjectTask")
                        .WithOne("Recurrence")
                        .HasForeignKey("BlitzTask.Backend.Features.ProjectTasks.TaskRecurrence", "ProjectTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BlitzTask.Backend.Features.TaskComments.TaskComment", b =>
                {
                    b.HasOne("BlitzTask.Backend.Features.Auth.User", "Author")
                        .WithMany()
