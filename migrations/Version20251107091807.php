...
final class Version20251107091807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task (id SERIAL NOT NULL, related_column_id INT NOT NULL, project_id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, due_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, priority VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
